...
<{else}>
  ...
  <form action="<{$xoops_url}>/modules/tad_cal/event.php" method="post" id="myForm" enctype="multipart/form-data" role="form">
    <!--事件標題-->
    ...
    <!--重複事件設定框-->
    <div class="card card-body bg-light m-1"id="repeat_box">
