<div class="container-fluid">
    ...
    <form action="main.php" method="post" id="myForm" enctype="multipart/form-data" class="form-horizontal" role="form">
      ...
      <{if $cate_handle|default:false}>
        ...
        <div class="form-group row mb-3">
          ...
          <div class="col-sm-4">
            <input type="text" name="google_id" value="<{$google_id|default:''}>" class="form-control" id="google_id" ><{$smarty.const._MA_TADCAL_GOOGLE_ID_NOTE}>
          </div>
          <!--google密碼-->
          <label class="col-sm-2 col-form-label text-sm-right control-label">
          ...
          <div class="col-sm-4">
            <input type="password" name="google_pass" value="<{$google_pass|default:''}>" class="form-control" id="google_pass" >
          </div>
        </div>
      <{/if}>
      ...
      <div class="text-center">
        <!--遠端行事曆-->
        <input type="hidden" name="cate_handle" value="<{$cate_handle|default:''}>">
        <!--行事曆排序-->
  ...
  <{elseif $op=="link_to_google"}>
    ...
    <{if $all|default:false}>
      ...
      <input type="hidden" name="google_id" value="<{$id|default:''}>">
      <input type="hidden" name="google_pass" value="<{$pass|default:''}>">
    ...
    <{else}>
      ...
      <{foreach item=cal from=$all_content}>
        <tr id="tr_<{$cal.cate_sn}>">
          ...
          <a href="main.php?op=tad_cal_cate_form&cate_sn=<{$cal.cate_sn}>" class="btn btn-sm btn-warning"><img src="../images/edit.png" title="<{$smarty.const._TAD_EDIT}>" alt="<{$smarty.const._TAD_EDIT}>" align="absmiddle" style="margin-right:4px;"><{$smarty.const._TAD_EDIT}></a>

          <{if $cal.cate_handle!=""}>
            <a href="import.php?cate_sn=<{$cal.cate_sn}>" class="btn btn-sm btn-info"><img src="../images/sync.png" title="<{$smarty.const._MA_TADCAL_GOOGLE_IMPORT}>" alt="<{$smarty.const._MA_TADCAL_GOOGLE_IMPORT}>" align="absmiddle" style="margin-right:4px;"><{$smarty.const._MA_TADCAL_GOOGLE_IMPORT}></a>
          <{/if}>
      ...
      <a href="main.php?op=tad_cal_cate_form" class="btn btn-sm btn-info"><img src="../images/date.png" title="<{$smarty.const._TAD_ADD_CAL}>" alt="<{$smarty.const._TAD_ADD_CAL}>" style="margin-right:4px;" align="absmiddle"><{$smarty.const._TAD_ADD_CAL}></a>

      <a href="main.php?op=tad_cal_all_sync"  class="btn btn-sm btn-info"><img src="../images/sync.png" title="<{$smarty.const._MA_TADCAL_ALL_SYNC}>" alt="<{$smarty.const._MA_TADCAL_ALL_SYNC}>" style="margin-right:4px;" align="absmiddle"><{$smarty.const._MA_TADCAL_ALL_SYNC}></a>

      <!--a href="main.php?op=tad_cal_add_gcal_form"  class="btn btn-sm btn-info"><img src="../images/google.png" title="<{$smarty.const._TAD_ADD_GOOGLE}>" alt="<{$smarty.const._TAD_ADD_GOOGLE}>" style="margin-right:4px;" align="absmiddle"><{$smarty.const._TAD_ADD_GOOGLE}></a-->
