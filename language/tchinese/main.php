...
define("_MD_TADCAL_KIND","事件種類");
define("_MD_TADCAL_DETAILS","事件內容");
define("_MD_TADCAL_ETAG","事件etag");
define("_MD_TADCAL_ID","事件id");
define("_MD_TADCAL_SEQUENCE","事件排序");
define("_MD_TADCAL_UID","發布者");
define("_MD_TADCAL_CATE_SN","所屬行事曆");
define("_MD_TADCAL_EVENT_FORM","設定事件");
define("_MD_TADCAL_TIME","時間起訖");
define("_MD_TADCAL_TODAY","今天");
define("_MD_TADCAL_PRE_MONTH","上個月");
define("_MD_TADCAL_NEXT_MONTH","下個月");
...
define("_MD_TADCAL_DTSTART","開始時間");
...
define("_MD_TADCAL_EMPTY_CATE","無任何行事曆可新增事件，請至後台新增行事曆。");
