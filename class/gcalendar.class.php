...
class GCalendar
{
     ...
     * @return bool|array Returns false on failure and array on success.
     */
    public function getOwnCalendars()
    {
        if ($this->authenticated === false) {
            return false;
        }
     ...
     * @return bool|object Returns false on failure and object on success.
     */
    public function getEvents($handle, $max = DEFAULT_MAX_EVENTS, $from = null, $to = null)
    {
        if ($this->authenticated === false) {
            return false;
     ...
     */
    public function getEvent($handle, $id, $etag)
    {
        if ($this->authenticated === false) {
            return false;
     ...
     * @return bool|object Returns false on failure and object on success
     */
    public function getEventByID($handle, $event_id)
    {
        if ($this->authenticated === false) {
            return false;
        } else if (empty($handle)) {
     ...
     * @return bool|object Returns false on failure and object on success
     */
    public function findEvent($handle, $query, $max = DEFAULT_MAX_EVENTS)
    {
        if ($this->authenticated === false) {
            return false;
        } else if (empty($query)) {
...
"end": "%s"
     ...
     */
    public function deleteEvent($handle, $id, $etag = null)
    {
        if ($this->authenticated === false) {
            return false;
     ...
     * @return bool|object Returns false on failure and object on success
     */
    public function updateEvent($handle, $id, $etag, $json)
    {
        if ($this->authenticated === false) {
            return false;
     ...
     */
    public function addUserToACL($handle = "default", $role = "read", $scope = null, $scopeType = "default")
    {
